...
- **9명 specialist**: YouTube, Designer, Writer, Coder(코다리), Business(이태원), Researcher, Editor, Instagram, Secretary
...
사용자: "이번 달 종합 보고서 — 유튜브 + 매출 + 다음 전략"
  ...
  CEO 책상 폭발 펄스 + 화이트보드
        ↓
  📺 홍병길·💼 이태원이 책상에서 일어나 **CEO 책상으로 walk** (회의실 모임)
        ↓
