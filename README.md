...
<h1 align="center">Connect AI v2 (P-Reinforce) for dongmin ai company</h1>

<p align="center">
  <strong>100% Local · 100% Offline · Private Knowledge Engine</strong><br/>
  VS Code / Cursor 확장 프로그램으로, dongmin ai company의 작업 공간을 개인 AI 지식 기지 및 에이전트 환경으로 진화시킵니다.
</p>
...
<p align="center">
  <strong>Customized for dongmin ai company</strong><br/>
  Powered by Connect AI Engine & Agent University
</p>
